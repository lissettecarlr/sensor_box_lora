...
__weak void OnRadioRxTimeout( void ){}	

__weak void OnRadioTxDone( void ){}

__weak void OnRadioRxDone( uint8_t *payload, uint16_t size, int16_t rssi, int8_t snr ){}

__weak void OnRadioTxTimeout( void ){}

__weak void OnRadioRxError( void ){}
            ...
            case MODEM_FSK:
                ...
                if( ( SX1276Events != NULL ) && ( SX1276Events->RxDone != NULL ) )
                {
                    //SX1276Events->RxDone( RxTxBuffer, SX1276.Settings.FskPacketHandler.Size, SX1276.Settings.FskPacketHandler.RssiValue, 0 );
										OnRadioRxDone( RxTxBuffer, SX1276.Settings.FskPacketHandler.Size, SX1276.Settings.FskPacketHandler.RssiValue, 0 );
								}
                SX1276.Settings.FskPacketHandler.PreambleDetected = false;
                SX1276.Settings.FskPacketHandler.SyncWordDetected = false;
                SX1276.Settings.FskPacketHandler.NbBytes = 0;
            ...
            case MODEM_LORA:
                {
                    ...
                    if( ( SX1276Events != NULL ) && ( SX1276Events->RxDone != NULL ) )
                    {
                        //SX1276Events->RxDone( RxTxBuffer, SX1276.Settings.LoRaPacketHandler.Size, SX1276.Settings.LoRaPacketHandler.RssiValue, SX1276.Settings.LoRaPacketHandler.SnrValue );
												OnRadioRxDone( RxTxBuffer, SX1276.Settings.LoRaPacketHandler.Size, SX1276.Settings.LoRaPacketHandler.RssiValue, SX1276.Settings.LoRaPacketHandler.SnrValue );
										}
                }
                break;
            default:
