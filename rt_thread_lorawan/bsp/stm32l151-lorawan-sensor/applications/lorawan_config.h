...
*/
#define LORAWAN_DEFAULT_JOIN_MODE    2              
#define LORAWAN_DEFAULT_JOIN_ADDR    ( uint32_t )0X06302EDA 
#define LORAWAN_DEFAULT_JOIN_DEVEUI  { 0X68, 0XD9, 0x00, 0x00, 0x00, 0x00, 0x02, 0x01 } //68d9000000000201
...
//F5 61 17 37 60 53 54 2E 89 44 80 DD 44 6D 9C B2
...
#define LROAWAN_DEFAULT_CHANNL  { 0x03FC,0x0000,0x0000,0x0000,0x0000,0x0000}//0x03FC
